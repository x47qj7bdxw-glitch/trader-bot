...
API_TOKEN = "8504604805:AAEO24lHMF9gGfcQmvorapZlQpAkXNbdAog"

# Настройка логов
logging.basicConfig(
    level=logging.INFO,
    format="%(asctime)s - %(levelname)s - %(message)s",
    filename="bot_log.txt",  # логи пишутся в файл
    filemode="a"
)
...
# Исходная ветка (откуда берём сообщения)
source_chat_id = -1003535658160
source_thread_id = 412

# Чат назначения (куда пересылаем)
